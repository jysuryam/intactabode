...
public class AddCustomer extends javax.swing.JDialog {
    ...
    public AddCustomer(java.awt.Frame parent, boolean modal) {
        ...
        cms.generateUniqueID("CUSTOMER", "UID");
    ...
    public void showCustmerData(String column, String like)
    {
        ...
        String query="SELECT ID,"
                ...
                + "PHONE"
                + " FROM CUSTOMER where "+column+" like '%"+like+"%' "
                +" order by id desc";
...
//        cms.fieldValidation(customer_Name, , "Name must not be Empty");
        ...
        try {
            ...
            if(i>0)
            {
            JOptionPane.showMessageDialog(this, "Customer added successful","successful",JOptionPane.INFORMATION_MESSAGE,cms.icon);
            showCustmerData("NAME","");
            clearFields();
            }
        } catch (Exception e) {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Add New Customer/Client");
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(customer_address1, javax.swing.GroupLayout.DEFAULT_SIZE, 441, Short.MAX_VALUE)
                    .addComponent(customer_gstIN, javax.swing.GroupLayout.DEFAULT_SIZE, 441, Short.MAX_VALUE)
                    .addComponent(customer_Name, javax.swing.GroupLayout.DEFAULT_SIZE, 441, Short.MAX_VALUE)
                    .addComponent(customer_email, javax.swing.GroupLayout.DEFAULT_SIZE, 441, Short.MAX_VALUE)
                    .addComponent(customer_phone, javax.swing.GroupLayout.DEFAULT_SIZE, 441, Short.MAX_VALUE)
                    .addComponent(customer_address2, javax.swing.GroupLayout.DEFAULT_SIZE, 441, Short.MAX_VALUE)
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        setSize(new java.awt.Dimension(668, 608));
